...
let count = 0;
let thisCount = 0;
const totalBoxes = 20; // Total number of boxes
  ...
  const adminCard = `
    ...
    admin.name
        ...
        <div class="ml-4">
          ...
          <p>Discord: ${admin.contact.discord}</p>
          <p>Contact: ${admin.contact.email}</p>
        </div>
      </span>
  ...
  function attemptPlay() {
    musicPlayer
      ...
      .catch((error) => {
        ...
        setTimeout(attemptPlay, 2000); // Retry after 2 seconds
      });
  }
